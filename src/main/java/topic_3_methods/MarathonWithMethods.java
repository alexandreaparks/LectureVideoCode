...
public class MarathonWithMethods {
    ...
    public static void main(String[] args) {
        ...
        marathonSchedule(currentDistance, marathonDistance, increase);



    }

    public static void marathonSchedule(double currentDistance, double marathonDistance, double increase) {
